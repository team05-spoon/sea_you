...
<main class="rbd-main" data-aos="fade-up" data-aos-duration="850">
  <section class="rbd-card">
    ...
    <header class="rbd-head">
      ...
      <div class="rbd-meta">
        작성일:
        <span><%= (bdto.getRb_date() != null ? sdf.format(bdto.getRb_date()) : "") %></span>
        <span class="dot">•</span>
        게시글 번호: <b><%= bdto.getRb_bno() %></b>
      </div>
    </header>
