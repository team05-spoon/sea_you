...
<link rel="stylesheet" href="<c:url value='/css/MessageWriteForm.css'/>">
...
<div class="top" data-aos="fade-down" data-aos-duration="850">
  ...
  <nav class="nav">
    ...
    <a href="/Chat/ChatRoom"
       onclick="window.open(this.href, 'chat', 'width=500, height=700'); return false;">전체채팅</a>
...
<!-- ✅ 쪽지 보내기(투명 박스) -->
<main class="msg-main" data-aos="fade-up" data-aos-duration="850">
  <section class="msg-card">
    <header class="msg-head">
      <h2 class="msg-title">쪽지 보내기</h2>
      <p class="msg-sub">상대에게 예의있게 메시지를 보내주세요.</p>
    </header>

    <form class="msg-form" name="MessageWriteForm" method="post" action="<c:url value='/Message/MessageWrite'/>">
      <input type="hidden" name="recv_nick" value="${recv_nick}">

      <div class="form-row">
        <label class="form-label">받는 사람</label>
        <div class="form-static">${recv_nick}</div>
      </div>

      <div class="form-row">
        <label class="form-label">내용</label>
        <textarea class="form-textarea" name="ms_content" placeholder="내용을 입력하세요..." required></textarea>
      </div>
