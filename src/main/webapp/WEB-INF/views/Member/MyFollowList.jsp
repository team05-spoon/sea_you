...
<main class="page" data-aos="fade-up" data-aos-duration="900">
  <section class="panel">
    <div class="panel-head">
      ...
      <div class="panel-sub">사용자를 클릭하면 해당 회원의 상세페이지로 이동합니다.</div>
    </div>
      ...
      <table class="member-table">
        ...
        <tbody>
          <c:choose>
            ...
            <c:otherwise>
              <tr><td class="empty" colspan="4">목록이 존재하지 않습니다.</td></tr>
            </c:otherwise>
          </c:choose>
        </tbody>
      </table>
    ...
    <div class="panel-foot">
      <a class="btn-ghost" href="javascript:history.back()">이전으로 돌아가기</a>
      <a class="btn-ghost" href="<c:url value='/'/>">메인으로</a>
    </div>
  </section>
</main>
