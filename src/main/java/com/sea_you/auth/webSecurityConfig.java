    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(request -> request
                ...
                .requestMatchers("/", "/Member/MemberWriteForm", "/Member/MemberWrite", "/Member/MemberLoginForm","/Beach/**", "/Place/**","/Member/jusoPopup","/Member/toggleFollow","/SearchList","/search","/autocomplete").permitAll()
                .requestMatchers("/css/**", "/js/**", "/m_images/**", "/video/**", "/images/**","/ChatBot/**").permitAll()
                .requestMatchers("/comments/**").hasAnyRole("USER", "ADMIN")
                .requestMatchers("/Member/**", "/Notice/**", "/BookMark/**", "/Report/ReportWriteForm", "/Chat/**","/Message/**","/Report/**").hasAnyRole("USER", "ADMIN")
